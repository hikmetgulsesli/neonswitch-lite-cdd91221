...
- NeonSwitch Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called NeonSwitch Lite. It should be a full-viewport browser-game where the player swaps neon rails, catches signal packets, avoids overload barriers, opens a settings overlay, saves preferences, pauses and resumes, and shows score, combo, lives, and level. Keep it polished, play…
...
- Gameplay - NeonSwitch Lite
- Game Settings - NeonSwitch Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - NeonSwitch Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - NeonSwitch Lite
